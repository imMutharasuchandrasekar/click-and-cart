...
{
    @Transactional
    OrderDTO placeOrder(String email, Long addressId, PaymentMethod paymentMethod, String paymentGatewayName, String paymentTransactionId, PaymentStatus paymentGatewayStatus, String paymentGatewayResponseMessage);
}
