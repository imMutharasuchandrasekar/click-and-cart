...
public class WebSecurityConfig {
    ...
    // This method completely excludes the specified URLs from any security filtering.
    @Bean
    ...
    public CommandLineRunner initData(RoleRepository roleRepository, UserRepository userRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            if (!userRepository.existsByUsername("user1")) {
                User user1 = new User("user1", "user1@email.com", passwordEncoder.encode("password1"));
                userRepository.save(user1);
            }

            if (!userRepository.existsByUsername("seller1")) {
                User seller1 = new User("seller1", "seller1@email.com", passwordEncoder.encode("password2"));
                userRepository.save(seller1);
            }

            if (!userRepository.existsByUsername("admin")) {
                User admin = new User("admin", "admin@email.com", passwordEncoder.encode("adminPass"));
